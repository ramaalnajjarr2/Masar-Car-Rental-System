...
public class CarsNormal extends Cars implements Rental,Order{
    private double CarPricePerDay;
    public CarsNormal() {
    }
    public CarsNormal(double CarPricePerDay, String CarName, String CarType, String CarColor, double CarPlateNumber, String CarState, int CarReleaseYear) {
